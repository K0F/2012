...
void gui() {
  ...
  // saving variables
  controlP5.addToggle("saveNormal",20,height-70,60,15).setLabel("Normal");
  controlP5.addToggle("saveGui",90,height-70,60,15).setLabel("Gui");
  controlP5.addToggle("saveContinuous",160,height-70,60,15).setLabel("Continuous");
  controlP5.addButton("save",0,20,height-40,200,20).setLabel("Toggle Saving (after 3 variables are set)");
